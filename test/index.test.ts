...
import {base64urlDecode} from '../src/base64url';
...
describe('all', () => {
  ...
  publicSsh.forEach((pub, index) => {
    it(`decoding ssh public key ${index}`, () => {
  ...
  [
    ...
    it(`Integer to Octet: ${t.len}`, () => {
      assert.deepEqual(integerToOctet(t.len), t.octet, t.len.toString());
    });
  });
